...
> Репозиторій для *високоякісних* визначень типів TypeScript.

*Ви також можете переглянути цей README [Іспанською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.es.md), [Корейською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.ko.md), [Російською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.ru.md), [Китайською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.zh.md), [Португальською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.pt.md), [Італійською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.it.md)
та [Японською](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.ja.md)!*

*Посилання на [Admin manual](./docs/admin.md)*

## Поточний статус

Ця секція відслідковує стан цього репозиторію та процес публікації.
Це може бути корисним для учасників що відчувають складнощі з їхніми PR та пакетами.

* Остання збірка [type-checked/linted](https://github.com/microsoft/DefinitelyTyped-tools/tree/master/packages/dtslint) детальніше: [![Build Status](https://dev.azure.com/definitelytyped/DefinitelyTyped/_apis/build/status/DefinitelyTyped.DefinitelyTyped?branchName=master)](https://dev.azure.com/definitelytyped/DefinitelyTyped/_build/latest?definitionId=1&branchName=master)
* Усі пакети проходять детальну перевірку-типів/лінтінг на `typescript@next`: [![Build status](https://dev.azure.com/definitelytyped/DefinitelyTyped/_apis/build/status/Nightly%20dtslint)](https://dev.azure.com/definitelytyped/DefinitelyTyped/_build/latest?definitionId=8)
* Усі пакети [публікуються на NPM](https://github.com/microsoft/DefinitelyTyped-tools/tree/master/packages/publisher) за півтори години: [![Publish Status](https://dev.azure.com/definitelytyped/DefinitelyTyped/_apis/build/status/DefinitelyTyped.types-publisher-watchdog?branchName=master)](https://dev.azure.com/definitelytyped/DefinitelyTyped/_build/latest?definitionId=5&branchName=master)
* [typescript-bot](https://github.com/typescript-bot) активний на Definitely Typed [![Activity Status](https://dev.azure.com/definitelytyped/DefinitelyTyped/_apis/build/status/DefinitelyTyped.typescript-bot-watchdog?branchName=master)](https://dev.azure.com/definitelytyped/DefinitelyTyped/_build/latest?definitionId=6&branchName=master)
* Поточний [статус оновлень інфраструктури](https://github.com/DefinitelyTyped/DefinitelyTyped/issues/44317)
...
Definitely Typed тестує пакети на версіях TypeScript яким менше ніж 2 роки.

<details>
<summary>Currently versions 4.1 and above are tested...</summary>

Якщо ви використовуєте версії TypeScript з 2.0 до 4.0, ви все ще можете спробувати встановити `@types` пакети &mdash; більшість пакетів не використовують нові функції TypeScript.
Але немає гарантії, що вони будуть працювати.
Графік оновлень:

<img src="docs/support-window.svg#gh-light-mode-only" style="width:100%">
<img src="docs/support-window.svg#gh-dark-mode-only" style="width:100%">

`@types` пакети мають мітки версій TypeScript які вони "явно" підтримують. Таким чином ви, зазвичай, можете встановити старіші версії пакетів що передують дворічному "вікну".
Наприклад, якщо
